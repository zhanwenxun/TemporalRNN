...
# train_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "svhn_data", "SVHN_train_32x32.mat")
# test_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "svhn_data", "SVHN_test_32x32.mat")
# extra_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "svhn_data", "SVHN_extra_32x32.mat")

train_path = "svhn_data/svhn/SVHN_train_32x32.mat"
test_path = "svhn_data/svhn/SVHN_test_32x32.mat"
extra_path = "svhn_data/svhn/SVHN_extra_32x32.mat"
...
def format_data(raw_data, number_of_examples):
    """
    Reshape RAW svhn_data to regular shape
    """
...
def load_svhn_data(train_path, test_path, extra_path, load_extra, eval_percentage):
    ...
    # Original setting split the svhn_data into training and validation samples
    ...
    print("Loading svhn_data completed")
