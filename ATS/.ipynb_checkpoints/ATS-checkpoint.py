...
class ATS(object):
    ...
    def get_priority_sequence(self, Tx, Ty, n, M, dense_model, base_path=None,prefix=None, is_save_ps=False,
                             th=0.001, dataset='mnist'):
        return self.ats_method.get_priority_sequence(Tx, Ty, n, M, dense_model, base_path=base_path,  prefix=prefix,
                                                     is_save_ps=is_save_ps, th=th, dataset=dataset)
